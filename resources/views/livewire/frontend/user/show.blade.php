                        ...
                        <div class="form-group breadcrumb-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                                ...
                                                class="mr-1" data-feather="mail"></i><span
                                                class="align-middle">Email</span></a><a class="dropdown-item"
                                                                                        href="app-calendar.html"><i
                                                class="mr-1" data-feather="calendar"></i><span class="align-middle">Calendar</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body profile-suggestion">
                                            ...
                                            <div class="d-flex justify-content-start align-items-center mb-1">
                                                ...
                                                <div class="profile-star ml-auto"><i data-feather="star"
                                            ...
                                            <div class="d-flex justify-content-start align-items-center mb-1">
                                                <div class="avatar mr-1">
                                                    <img src="../../../app-assets/images/avatars/10-small.png"
                                                         alt="avatar" height="40" width="40"/>
                                                </div>
                                                <div class="profile-user-info">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="profile-twitter-feed mt-1">
                                                ...
                                                <p class="card-text mb-50">I love cookie chupa chups sweet tart apple
                                                    pie ⭐️ chocolate bar.</p>
                                                <a href="javascript:void(0)">
                                            ...
                                            <div class="profile-twitter-feed mt-2">
                                                <div class="d-flex justify-content-start align-items-center mb-1">
                                                    ...
                                                    <div class="profile-star ml-auto">
                                                        <i data-feather="star"
                                                           class="font-medium-3 profile-favorite"></i>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="profile-twitter-feed mt-2">
                                                ...
                                                <p class="card-text mb-50">Candy jelly beans powder brownie biscuit.
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="bestActorPoll2" name="bestActorPoll"
                                                               class="custom-control-input"/>
                                                        <label class="custom-control-label" for="bestActorPoll2">Chris
                                                            Hemswort</label>
                                                    </div>
                                                    <!--/ custom radio -->
